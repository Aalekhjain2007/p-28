...
function setup(){
 ...
 mango1=new Mango(800,300,60,60);
 mango2=new Mango(700,350,60,60);
 mango3=new Mango(720,240,60,60);
 mango4=new Mango(620,300,60,60);
 mango5=new Mango(640,240,60,60)
